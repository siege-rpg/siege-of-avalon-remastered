...
uses
  Classes, SysUtils, Character, Engine, Anigrp30, LogFile,
  Dialogs, Resource, Graphics, Math, strfunctions;
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        ...
                        if (S = 'humanoidmeleetraining') then
                          Result := TMeleeTraining.Create
                        else
                          if (S = 'humanoidmeleesparing') then
                            Result := TMeleeSparing.Create
                          else
                            if (S = 'humanoidmeleepratice') then
                              Result := TMeleePratice.Create
                            else
                              if (S = 'enviromentdamage') then
...
begin
  ...
  try
    ...
    on E: Exception do Log.log('Error Humanoid GetFacing: ' + E.Message);
  end;
end;
...
{$ENDIF}
  ...
  try
    ...
    on E: Exception do Log.log('Error TCompanion CollideFigure: ' + E.Message);
  end;
end;
...
{$ENDIF}
  try
    ...
    on E: Exception do Log.log('Error Companion FollowPlayer: ' + E.Message);
  end;
end;
  ...
  try
      ...
      if AttackFrame = 0 then
        ...
        begin
          ...
          begin //dont get to far away;
            ...
            if FMeleeAggressive and not(Character.InRange(Character.Track)) then
        ...
        on E: Exception do Log.log('Error Companion AttackMelee1: ' + E.Message);
      end;
    ...
    begin //hit him then
      try
        ...
        on E: Exception do Log.log('Error Companion AttackMelee2: ' + E.Message);
      end;
    end;
    ...
    begin
        try
          ...
          begin
              ...
              on E: Exception do Log.log('Error Companion AttackMelee3: ' + E.Message);
        end;
    end;
  except
    on E: Exception do Log.log(FailName, E.Message, []);
...
begin
      try
        ...
        on E: Exception do Log.log('Error Companion FightBack: ' + E.Message);
      end;
end;
...
//          player.say('move on',clblue);
  ...
  //        else
   ...
   //             Character.Attack(Character.Track);
    ...
    on E: Exception do Log.log('Error HumanoidArcher Attack: ' + E.Message);
...
{$ENDIF}
  ...
  try
    ...
    on E: Exception do Log.log('Error Companion BattleTactic: ' + E.Message);
      ...
      begin
        ...
        begin
            ...
            begin
                try
                  ...
                  on E: Exception do Log.log('Error Companion AttackCaster1: ' + E.Message);
                end;
            end
            else
            begin
        ...
        begin
          try
            ...
            on E: Exception do Log.log('Error Companion AttackCaster2: ' + E.Message);
          end;
        end
        else
        begin
          try
            ...
            on E: Exception do Log.log('Error Companion AttackCaster3: ' + E.Message);
          end;
        end;
    end;
...
{$ENDIF}
  try
    ...
    on E: Exception do Log.log('Error Companion MoveAway: ' + E.Message);
  end;
end;
          ...
          if Assigned(character.Equipment[slMisc1]) then
            ...
            begin
              ...
              begin
                ...
                if bPlaySFXMetal and bPlaySFXAttack then
                begin
                  case Random(2) of
                  ...
                  if bPlaySFXMetal and bPlaySFXOther then
                  begin
                    case Random(2) of
                      0: PlaySound(TWeapon(character.Equipment[slMisc1]).StrikeLeatherSounds, character.X, character.Y);
                      1: PlaySound(TWeapon(character.Equipment[slMisc1]).StrikeMetalSounds, character.X, character.Y);
                    ...
                    if bPlaySFXAttack and bPlaySFXOther then
                    begin
                      case Random(2) of
                        0: PlaySound(TWeapon(character.Equipment[slMisc1]).StrikeLeatherSounds, character.X, character.Y);
                        1: PlaySound(TWeapon(character.Equipment[slMisc1]).AttackSounds, character.X, character.Y);
...
{$ENDIF}
  ...
  try
    ...
    on E: Exception do Log.log('Error TGuardDog CollideFigure: ' + E.Message);
  end;
end;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                if Pos('party', Lowercase(tmpEnemies)) <> 0 then
                begin
...
{      if (FrameCount mod 360) = 0 then
    ...
    on E: Exception do Log.log('Error GuardDog FollowFMaster: ' + E.Message);
  end;
end;
  ...
  try
    ...
    begin
      ...
      try
        ...
        on E: Exception do Log.log('Error GuardDog AttackMelee1: ' + E.Message);
      end;
...
//        if Not(IsAnybodyInTheWay(character,TCharacter(Character.track), 20)) then
        ...
        on E: Exception do Log.log('Error GuardDog AttackMelee2: ' + E.Message);
      end;
    end
    else
      if not (walking) then
      begin
        ...
        try
          ...
          on E: Exception do Log.log('Error GuardDog AttackMelee3: ' + E.Message);
        end;
...
{$ENDIF}
  try
    ...
    on E: Exception do Log.log('Error GuardDog BattleTactic: ' + E.Message);
  end;
end;
      ...
      begin
        ...
        begin
          try
            ...
            on E: Exception do Log.log('Error GuardDog AttackCaster1: ' + E.Message);
          end;
        ...
        begin
          try
            ...
            on E: Exception do Log.log('Error GuardDog AttackCaster2: ' + E.Message);
          end;
        end
        else
        begin
          try
            ...
            on E: Exception do Log.log('Error GuardDog AttackCaster3: ' + E.Message);
          end;
        end;
    end;
...
{$ENDIF}
  try
    ...
    on E: Exception do Log.log('Error GuardDog MoveAway: ' + E.Message);
  end;
end;
            ...
            begin //Assign each ally a diff target
              if Assigned(TCharacter(FList.Objects[iFriend]).AI) then
                if TCharacter(FList.Objects[iFriend]).AiMode = aiIdle then
                  ...
                  if TCharacter(FList.Objects[iFriend]).AiMode = aiCombat then
                    if Assigned(TCharacter(FList.Objects[iFriend]).AI) then
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if Assigned(Character.Track) and not (Character.InRange(Character.Track)) then
          begin
            Inc(CollideCount);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (MyGroup.Objects[i] is TPathCorner) then
          begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if not (CurrentPath is TPathCorner) then CurrentPath := nil;
      end;
    end;
  except
    on E: Exception do Log.log(FailName, E.Message, []);
...
{$ENDIF}
  try
    ...
    begin
      if Character.Track = Player then Character.Track := nil;
      AttackCaster;
    end;
...
{$ENDIF}
  try
    ...
    on E: Exception do Log.log('Error WatchDog BattleTatic: ' + E.Message);
  end;
end;
...
{$ENDIF}
  try
    ...
    if ((FrameCount mod 500) = 0) then bHarassing := False;
  ...
  try
    ...
    begin
      try
        ...
        on E: Exception do Log.log('Error Worms AttackMelee2: ' + E.Message);
      end;
    end
    else
    begin
      try
        ...
        on E: Exception do Log.log('Error Worms AttackMelee3: ' + E.Message);
      end;
    end;
...
{$ENDIF}
  try
    ...
    on E: Exception do Log.log('Error Companion BattleTatic: ' + E.Message);
  end;
end;
...
{$ENDIF}
  ...
  try
    ...
    on E: Exception do Log.log('Error HumanoidCaster FindFriendly: ' + E.Message);
...
{$ENDIF}
  try
    ...
    inherited;
    try
      if not (Character.TitleExists('02atstone')) then exit;
      if Delay > 0 then
      begin
        dec(Delay);
      ...
      on E: Exception do Log.log('Error HumanoidRitual Execute: ' + E.Message);
    end;
...
{$ENDIF}
  ...
  try
    ...
    on E: Exception do Log.log('Error HumanoidRitual Init: ' + E.Message);
  end;
...
{$ENDIF}
  try
    ...
    try
      ...
      on E: Exception do Log.log('Error Melee Execute: ' + E.Message);
    end;
...
{$ENDIF}
  ...
  try
    ...
    on E: Exception do Log.log('Error Melee FindNextTarget: ' + E.Message);
  end;
...
{$ENDIF}
  try
    ...
    try
      ...
      on E: Exception do Log.log('Error Melee Attack: ' + E.Message);
...
{$ENDIF}
  ...
  try
    ...
    on E: Exception do Log.log('Error Melee CollideFigure: ' + E.Message);
  end;
...
{$ENDIF}
  ...
  try
    ...
    on E: Exception do Log.log('Error Melee NoPath: ' + E.Message);
  end;
...
{$ENDIF}
  try
    ...
    try
      ...
      on E: Exception do Log.log('Error Melee Stop: ' + E.Message);
    end;
...
{$ENDIF}
  try
    ...
    try
      ...
      on E: Exception do Log.log('Error Melee WasAttacked: ' + E.Message);
    end;
...
{$ENDIF}
  try
    ...
    try
      ...
      on E: Exception do Log.log('Error MeleePractice Execute: ' + E.Message);
    end;
...
{$ENDIF}
  ...
  try
    ...
    on E: Exception do Log.log('Error Melee Init: ' + E.Message);
  end;
...
//  Delay := 0;
  try
    ...
    on E: Exception do Log.log('Error MeleePratice WasAttacked: ' + E.Message);
  end;
...
begin
  ...
  try
    ...
    on E: Exception do Log.log('Error MeleePratice WasKilled: ' + E.Message);
  end;
...
{$ENDIF}
  try
    ...
    try
      ...
      on E: Exception do Log.log('Error MeleeSparing Execute: ' + E.Message);
    end;
...
{$ENDIF}
  try
    ...
    try
      ...
      on E: Exception do Log.log('Error MeleeSparing WasAttacked: ' + E.Message);
    end;
...
begin
  try
    ...
    on E: Exception do Log.log('Error Obelisk Clicked: ' + E.Message);
  end;
...
//        log.log('RunScript: ' + strScript);
        ...
        on E: Exception do Log.log('Error Runscript Execute: ' + E.Message);
  end;
end;
...
begin
  try
    ...
    on E: Exception do Log.log('Error Clone Player: ' + E.Message);
  end;
end;
