    ...
    begin //P - Pause
      ...
      begin
        ...
        begin
          ...
          WrapperBltFast( lpDDSFront,  0, 486, OverlayB, Rect( 0, 0, 800, 114 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
          ...
          begin
            ...
            WrapperBlt( lpDDSFront, Rect( NPCBarXCoord[ i ], 581 - Round( HPDistance ), NPCBarXCoord[ i ] + 5, 581 ),
              nil, Rect( 0, 0, 0, 0 ), DDBLT_COLORFILL + DDBLT_WAIT, NPCHealthBltFx );

            WrapperBlt( lpDDSFront, Rect( NPCBarXCoord[ i ] + 7, 581 - Round( ManaDistance ), NPCBarXCoord[ i ]
...
{$ENDIF}
  try
    ...
    if i > 80 then
      ...
      i := 0;
    WrapperBltFast( lpDDSBack,  699, 134, ManaEmpty, Rect( 0, 0, 78, i ), DDBLTFAST_NOCOLORKEY or DDBLTFAST_WAIT );
    ...
    if i > 107 then
      ...
      i := 0;
    WrapperBltFast( lpDDSBack,  709, 248, LifeEmpty, Rect( 0, 0, 52, i ), DDBLTFAST_NOCOLORKEY or DDBLTFAST_WAIT );
    ...
    begin
      ...
      begin
        ...
        WrapperBlt( lpDDSBack,  Rect( NPCBarXCoord[ i ], 581 - Round( HPDistance ), NPCBarXCoord[ i ] + 5, 581 ),
          nil, Rect( 0, 0, 0, 0 ), DDBLT_COLORFILL + DDBLT_WAIT, NPCHealthBltFx );

        WrapperBlt( lpDDSBack,  Rect( NPCBarXCoord[ i ] + 7, 581 - Round( ManaDistance ), NPCBarXCoord[ i ]
          + 7 + 5, 581 ), nil, Rect( 0, 0, 0, 0 ), DDBLT_COLORFILL + DDBLT_WAIT, NPCManaBltFx );
      end;
    end;
...
{$IFDEF DirectX}
    if SpellBarActive then
    begin
      WrapperBltFast( lpDDSBack,  0, 486, SpellBar, Rect( 0, 0, 800, 114 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
      WrapperBltFast( lpDDSBack,  250, 455, HelpBox, Rect( 0, 0, 195, 59 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    end
    else
    begin
      if Assigned( HLFigure ) and ( HLFigure is TSpriteObject ) then
        ...
        ShowMouseMessage( '' );
      WrapperBltFast( lpDDSBack,  0, 486, OverlayB, Rect( 0, 0, 800, 114 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    end;
    WrapperBltFast( lpDDSBack,  683, 0, OverlayR, Rect( 0, 0, 117, 486 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
              ...
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    WrapperBltFast( lpDDSFront,  699, 0, OverlayR, Rect( 16, 0, 117, 120 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
                    BeginStatistics( Current );
                  end
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  CloseAllDialogs( DlgStatistics );
                  ChangeFocus( NPCList.Items[ i ] );
                  WrapperBltFast( lpDDSFront,  0, 498, OverlayB, Rect( 0, 12, 326, 114 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
                  WrapperBltFast( lpDDSFront,  699, 0, OverlayR, Rect( 16, 0, 117, 120 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
                  BeginStatistics( Current );
                end
                else if DlgInventory.Loaded then
...
{$ENDIF}
  try
    ...
    try
      ...
      WrapperBltFast( NoSpellIcon, 0, 0, OverlayB, Rect( 456, 64, 456 + 32, 64 + 32 ), DDBLTFAST_NOCOLORKEY
        or DDBLTFAST_WAIT );
...
{$ENDIF}
  try
    ...
    WrapperBltFast( OverlayB, 339, 64, NoSpellIcon, Rect( 0, 0, 32, 32 ), DDBLTFAST_NOCOLORKEY or DDBLTFAST_WAIT );
...
{$ENDIF}
  try
    ...
    begin
      ...
      WrapperBltFast( lpDDSBack,  683, 0, OverlayR, Rect( 0, 0, 117, 133 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
    end
    else if i >= 1 then
    begin
      if not SpellBarActive then
...
begin
  ...
  begin
    MouseCursor.cleanup;
    WrapperBltFast( lpDDSFront,  659, 486 + 50, OverlayB, Rect( 659, 50, 659 + 68, 50 + 24 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
  end;
end;
...
begin
  ...
  begin
    MouseCursor.cleanup;
    WrapperBltFast( lpDDSFront, 659, 486 + 26, OverlayB, Rect( 659, 26, 659 + 68, 26 + 24 ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
  end;
end;
...
begin
  ...
  if ( FMsgID > 0 ) and Assigned( Surface ) then
    WrapperBltFast( lpDDSBack,  FX, FY, Surface, Rect( 0, 0, FWidth, Height ), DDBLTFAST_NOCOLORKEY or DDBLTFAST_WAIT );
