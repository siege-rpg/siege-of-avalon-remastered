                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        ...
                        WrapperBlt( TempSurface, Rect( 0, 0, FTileWidth, FTileHeight ), nil, Rect( 0, 0, FTileWidth, FTileHeight ), DDBLT_COLORFILL + DDBLT_WAIT, BltFx );
                        if ( Index <> $FFFF ) then
                        begin
                          SrcX := ( Index div ZoneTile.FTileMaxColumnIndex ) * FTileWidth;
                          SrcY := ( Index mod ZoneTile.FTileMaxColumnIndex ) * FTileHeight + HalfHeight;
                          WrapperBltFast( TempSurface, 0, 0, ZoneTile.FTileImages, Rect( SrcX, SrcY, SrcX + FTileWidth, SrcY + HalfHeight ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
                        end;
                        Index := p^.Tile[ 2 ];
                        if ( Index <> $FFFF ) then
                        begin
                          ...
                          WrapperBltFast( TempSurface, HalfWidth, 0, ZoneTile.FTileImages, Rect( SrcX, SrcY, SrcX + HalfWidth, SrcY + FTileHeight ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
                        end;
                        Index := p^.Tile[ 3 ];
                        if ( Index <> $FFFF ) then
                        begin
                          ...
                          WrapperBltFast( TempSurface, 0, HalfHeight, ZoneTile.FTileImages, Rect( SrcX, SrcY, SrcX + FTileWidth, SrcY + HalfHeight ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
                        end;
                        Index := p^.Tile[ 4 ];
                        if ( Index <> $FFFF ) then
                        begin
                          ...
                          WrapperBltFast( TempSurface, 0, 0, ZoneTile.FTileImages, Rect( SrcX, SrcY, SrcX + HalfWidth, SrcY + FTileHeight ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
                        end;
                      end
                      else
                      begin
                        SrcX := ( Index div ZoneTile.FTileMaxColumnIndex ) * FTileWidth;
                        SrcY := ( Index mod ZoneTile.FTileMaxColumnIndex ) * FTileHeight;
                        WrapperBltFast( TempSurface, 0, 0, ZoneTile.FTileImages, Rect( SrcX, SrcY, SrcX + FTileWidth, SrcY + FTileHeight ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
                      end;
...
//Log.Log('15');
  BltFx.dwFillColor := 0;
//Log.Log('16');
  WrapperBlt( lpDDSBack, Rect( 0, 0, ResWidth, ResHeight ), nil, Rect( 0, 0, ResWidth, ResHeight ), DDBLT_COLORFILL + DDBLT_WAIT, BltFx );
//Log.Log('17');
...
{$IFDEF DirectX}
    WrapperBltFast( lpDDSBack, Left, Top, lpDDSMap, Rect( MapOffsetX, MapOffsetY, MapOffsetX + Width, MapOffsetY + Height ), DDBLTFAST_NOCOLORKEY or DDBLTFAST_WAIT );
...
{$IFDEF DirectX}
    ...
    WrapperBlt( Work, Rect( WorkWidth div 2, 0, WorkWidth div 2 + XRayWidth + FMap.FStripWidth, XRayHeight ), nil, Rect( 320, 0, 320 + XRayWidth + FMap.FStripWidth, XRayHeight ), DDBLT_COLORFILL + DDBLT_WAIT, BltFx );
{$ENDIF}
{$IFNDEF DirectX}
                    ...
                    begin
                      ...
                      begin
                        ...
                        begin
                          ...
                          WrapperBltFast( lpDDSBack, left + DstX1, top + XRayY2 - OffsetY, ZoneItem.FItemImages,
                        ...
                        begin
                          ...
                          if H > Y then
                            H := Y;
                          WrapperBltFast( lpDDSBack, left + DstX1, top + DstY1, ZoneItem.FItemImages,
                      ...
                      WrapperBltFast( Work, 0, 0, ZoneItem.FItemImages,
                      ...
                      WrapperBltFast( Work, j, 0, XRayImage,
                        Rect( X, Y, W, H ),
                        DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );

                      ddck.dwColorSpaceLowValue := FMap.FColorMatch;
                      ddck.dwColorSpaceHighValue := ddck.dwColorSpaceLowValue;
                      Work.SetColorKey( DDCKEY_SRCBLT, {$IFNDEF DX5}@{$ENDIF}ddck );
                      WrapperBltFast( lpDDSBack, Left + DstX1, Top + DstY1, Work, Rect( 0, 0, SrcX2 - SrcX1, SrcY2 - SrcY1 ),
                        DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
                    end
                    else
                    begin
                      ...
                      begin
                        ...
                        Clip( XRayY1 - OffsetY, XRayY2 - OffsetY, DstY1, DstY2, SrcY1, SrcY2 );
                      WrapperBltFast( lpDDSBack, Left + DstX1, Top + DstY1, ZoneItem.FItemImages, Rect( SrcX1, SrcY1, SrcX2, SrcY2 ),
                        RepaintCode ); //****
                    end;
{$ENDIF}
{$IFNDEF DirectX}
...
{$ENDIF}
{$IFDEF DirectX}
    {    WrapperBltFast( Work, 320+KeyFigure.FX-XRayWidth div 2-OffsetX-KeyX,0,
          XRayImage,Rect(0,0,XRayWidth,XRayHeight),DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT);
        ddck.dwColorSpaceLowValue:=FMap.FColorMatch;
        ddck.dwColorSpaceHighValue:=ddck.dwColorSpaceLowValue;
        Work.SetColorKey(DDCKEY_SRCBLT,ddck);
        WrapperBltFast( lpDDSBack, KeyX+left,KeyY+top,Work,Rect(WorkWidth div 2,0,WorkWidth div 2+XRayWidth+FMap.FStripWidth,XRayHeight),
          DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT);   }
{$ENDIF}
  end;
...
{$IFDEF DirectX}
    ...
    WrapperBltFast( lpDDSMap, X, Y, lpDDSMap, Rect( SrcX1, SrcY1, SrcX2, SrcY2 ),
      DDBLTFAST_NOCOLORKEY or DDBLTFAST_WAIT );
{$ENDIF}
{$IFNDEF DirectX}
...
{$IFDEF DirectX}
  ...
  ddck.dwColorSpaceLowValue := FMap.FColorMatch;
  ddck.dwColorSpaceHighValue := ddck.dwColorSpaceLowValue;
  lpDDSMap.SetColorKey( DDCKEY_SRCBLT, {$IFNDEF DX5}@{$ENDIF}ddck );

  ddck.dwColorSpaceLowValue := FMap.FColorMatch;
  ddck.dwColorSpaceHighValue := ddck.dwColorSpaceLowValue;
  lpDDSBack.SetColorKey( DDCKEY_SRCBLT, {$IFNDEF DX5}@{$ENDIF}ddck );
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          WrapperBltFast( lpDDSBack, XA, YA, TZone( FMap.Zones.Items[ FMap.FItemList[ i ].Zone ] ).FItemImages,
...
begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if ( Layer = 0 ) then
            begin
              WrapperBltFast( Work, X, Y, Zone.FTileImages, Rect( SrcX, SrcY,
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        WrapperBltFast( Work, X - ZoneX, Ya - ZoneY, Zone.FItemImages, Rect( SrcX1, SrcY1a, SrcX2, SrcY2a ),
          DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );

        //also clip x against edge of screen
        Clip1( Y, ZoneY, Y, SrcY1, SrcY2 );
        Clip1( 0, Width, X, SrcX1, SrcX2 );
        WrapperBltFast( lpDDSBack, X + Left, Y + Top, Zone.FItemImages, Rect( SrcX1, SrcY1, SrcX2, SrcY2 ),
          DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
      end;
    end;
  end;
  ...
  WrapperBltFast( Work, SrcX, SrcY, lpDDSBack, Rect( ZoneX + Left, ZoneY + Top, ZoneX + Left + W, ZoneY + Top + H ), DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
  WrapperBltFast( lpDDSBack, ZoneX + Left, ZoneY + Top, Work, Rect( SrcX, SrcY, SrcX + W, SrcY + H ), DDBLTFAST_NOCOLORKEY or DDBLTFAST_WAIT );
end;
{$ENDIF}
...
{$IFDEF DirectX}
            ...
            begin
              ...
              begin
                WrapperBltFast( lpDDSMap, X, Y, ZoneItem.FItemImages, Rect( FMap.FItemList[ i ].ImageX, SrcY1,
...
{$IFDEF DirectX}
                ...
                begin
                  ...
                  begin
                    if not ZoneItem.FullRefresh then
                    begin
                      WrapperBltFast( lpDDSMap, DstX, DstY, ZoneItem.FItemImages, Rect( SrcX, SrcY1,
...
{$IFDEF DirectX}
                ...
                begin
                  ...
                  begin
                    if not ZoneItem.FullRefresh then
                    begin
                      WrapperBltFast( lpDDSMap, DstX, DstY, ZoneItem.FItemImages, Rect( FMap.FItemList[ i ].ImageX, SrcY1,
...
{$IFDEF DirectX}
      ...
      begin
        ...
        begin
          WrapperBltFast( Dest, DstX, DstY, ZoneTile.FTileImages, Rect( SrcX, SrcY,
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            BltFx.dwSize := SizeOf( BltFx );
            BltFx.dwFillColor := FMap.FColorMatch;
            WrapperBlt( Dest, Rect( X, Y, DstX, DstY ), nil, Rect( X, Y, DstX, DstY ), DDBLT_COLORFILL + DDBLT_WAIT, BltFx );
            Exit;
          end
          else
          begin
...
//Log.Log(inttostr(NewBitHeight)+' '+inttostr(FTileBitHeight));
            ...
            BltFx.dwSize := SizeOf( BltFx );
            BltFx.dwFillColor := FMap.ColorMatch;
            WrapperBlt( NewTileImages, Rect( 0, 0, NewBitWidth, NewBitHeight ), nil,
              Rect( 0, 0, NewBitWidth, NewBitHeight ), DDBLT_COLORFILL + DDBLT_WAIT, BltFx );
            if Assigned( FTileImages ) then
            begin
              WrapperBltFast( NewTileImages, 0, 0, FTileImages, Rect( 0, 0, FTileBitWidth, FTileBitHeight ), DDBLTFAST_NOCOLORKEY or DDBLTFAST_WAIT );
            end;

            ddck.dwColorSpaceLowValue := FMap.ColorMatch;
            ddck.dwColorSpaceHighValue := ddck.dwColorSpaceLowValue;
            NewTileImages.SetColorKey( DDCKEY_SRCBLT, {$IFNDEF DX5}@{$ENDIF}ddck );
          ...
          begin
            ...
            begin
              ...
              if SrcY2 > H then
                SrcY2 := H;
              WrapperBltFast( FTileImages, X, Y, Image, Rect( SrcX1, SrcY1, SrcX2, SrcY2 ),
                DDBLTFAST_SRCCOLORKEY or DDBLTFAST_WAIT );
...
//    end;
          ...
          BltFx.dwSize := SizeOf( BltFx );
          BltFx.dwFillColor := FMap.ColorMatch;
          WrapperBlt( FTileImages, Rect( 0, 0, FTileBitWidth, FTileBitHeight ), nil,
  ...
  {  BltFx.dwSize := SizeOf(BltFx);
    ...
    WrapperBlt( NewItemImages, Rect(0, 0, NewBitWidth, NewBitHeight), nil,
      Rect(0, 0, NewBitWidth, NewBitHeight), DDBLT_COLORFILL + DDBLT_WAIT, BltFx);  }
            ...
            WrapperBltFast( NewItemImages, NewX, NewY, Image, Rect( 0, 0, W, H ), DDBLTFAST_NOCOLORKEY or DDBLTFAST_WAIT );
          ...
          begin
            WrapperBltFast( FItemImages, NewX, NewY, Image, Rect( 0, 0, W, H ), DDBLTFAST_NOCOLORKEY or DDBLTFAST_WAIT );
          end;
      {$ENDIF}
      {$IFNDEF DirectX}
          ScreenDC := GetDC( 0 );
